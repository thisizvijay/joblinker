...
export default function Home() {
  return (
    <>
        ...
        <section className="min-h-screen w-[90%] md:w-auto mx-auto">
          ...
          <div className="flex">
            <div className="w-full md:w-2/5  min-h-fit		">
              ...
              <button
                className="
              bg-gradient-to-r from-[#5350FF]   to-[#DF0F99] text-white px-10 py-3 rounded-full my-10 shadow-md hover:shadow-lg
              "
              >
                Sign Up
              </button>
              <button
                className="
            border px-10 py-3 rounded-full my-10 ml-3 inline-block hover:shadow-lg bg-white"
              >
                Watch Demo
              </button>
              ...
              <img
                ...
                className="absolute bottom-0 left-0 w-52 h-52 -z-20 opacity-40 hidden md:inline-block"
              />
            </div>
            <div className="hidden md:w-3/5  md:block	">
              <img src="/images/main-illustration.svg" className="relative -top-28 h-[640px]" />
            </div>
          </div>
          ...
          <img src="/images/main-illustration.svg" className="block md:hidden relative" />
        </section>
      </div>

      <section className="relative">
        <img src="/images/rocket.png" className="absolute -bottom-24 -right-6 h-56" />
        <div className="flex flex-col md:flex-row">
          <div className="w-full md:w-1/2">
            <img src="/images/effortless-connections.svg" />
          </div>
          <div className="w-full md:w-1/2">
      ...
      <section className="relative">
        <div className="flex">
          ...
          <div className="w-1/2 text-right relative ">
            <img src="/images/power-of-referrals.svg" className="h-[600px] relative -right-9" />
          </div>
        </div>
      </section>
      <section className="relative">
        <img src="/images/resume.png" className="absolute top-20 right-12" />
        <div className="flex">
          <div className="w-1/2">
            <img src="/images/hiring-process.svg" />
          </div>
          <div className="w-1/2">
            <div className="w-2/3 mx-auto pt-24">
              <p className="py-6">&nbsp;</p>
      ...
      {/* clearfix */}
      <div className="clearfix py-10 my-10"></div>
        ...
        <div className="flex">
          <div className="w-1/2">
            <div className="w-2/3 mx-auto">
              ...
              <h1 className="text-6xl my-4 font-bold">Features That Empower You</h1>
              ...
              <div className="p-4 bg-white rounded-lg mt-3 border hover:shadow-sm cursor-pointer">
                <div className="flex flex-row">
                  ...
                  <div
                    ...
                    justify-center pl-6 font-semibold
                  "
                  >
      ...
      <section className="relative h-[500px]">
        ...
        <img
          ...
          className="absolute w-screen -top-[450px] left-0 pointer-events-none -z-10"
        />
      </section>
      <div className="container mx-auto">
        <section className="relative mt-20">
          <div className="p-20 py-20 relative bg-[#FFFBF0] w-auto mx-auto mt-10 text-center">
            <img src="/images/graphic-elements.svg" className="absolute -top-10 -left-10" />
            <img src="/images/rings.svg" className="absolute -right-28 -bottom-40" />
            ...
            <div className="flex justify-center mt-5">
              <div className="flex flex-row">
                ...
                <div className="flex flex-col">
                  <button className="bg-[#5D50C6] text-white p-4 rounded-2xl">Subscribe</button>
                </div>
              </div>
            </div>
            <p>&nbsp;</p>
